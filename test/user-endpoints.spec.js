...
describe('User Endpoints', function () {
  ...
  describe(`POST /api/user`, () => {
    ...
    it(`responds 400 'User name already taken' when username isn't unique`, () => {
      ...
      return supertest(app).post('/api/user').send(duplicateUser).expect(400, { error: `Username already taken` });
    });
    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'batlh', translation: 'honorable' },
            { original: 'cheron', translation: 'battlefield' },
            { original: 'mayduj', translation: 'battle cruiser' },
            { original: 'bah', translation: 'fire' },
            { original: 'ghus', translation: 'attack' },
            { original: 'hod', translation: 'captain' },
            { original: 'hegh', translation: 'death' },
            { original: 'hudyuq', translation: 'planet' },
          ],
        };
        return supertest(app)
          .post('/api/user')
